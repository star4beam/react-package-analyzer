...
|----------|-------|----------|-------|
| Component | ListItem | Package | @mui/material |
...
|------|------------|----------------|
| [src/components/dashboard/ActivityFeed.jsx](https://github.com/star4beam/react-import-analyzer/blob/main/test-project/src/components/dashboard/ActivityFeed.jsx) | `sx`, `children` | 2 |
